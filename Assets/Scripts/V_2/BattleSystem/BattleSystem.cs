...
namespace BattleSystem
{
    public class BattleSystem : MonoBehaviour
    {
        ...
        {
            var entityBattleVisuals = Instantiate(entity.GetBattleVisualsPrefab(), spawnPoint.position, Quaternion.identity).GetComponent<BattleVisuals>();
